...
# ================================
# Lab17: AWS Backup 서비스 - 자동화된 백업 및 복원 정리
# ================================
# 목적: Lab17에서 생성된 모든 AWS 리소스를 안전하게 정리
# ================================
...
check_existing_resources() {
    ...
    if [ "$VPC_ID" != "None" ] && [ -n "$VPC_ID" ]; then
        ...
        echo "ℹ️ 삭제할 Lab17 VPC 리소스가 없습니다."
    fi
...
show_cleanup_summary() {
    echo ""
    show_success "🎉 Lab17 리소스 정리가 완료되었습니다!"
    echo ""
    ...
    echo "💰 비용 절약"
    echo "• 모든 Lab17 관련 리소스가 정리되어 추가 비용이 발생하지 않습니다"
...
main() {
    # 헤더 표시
    echo "================================"
    echo "Lab17: AWS Backup 서비스 - 자동화된 백업 및 복원 정리"
    echo "================================"
    echo "목적: Lab17에서 생성된 모든 AWS 리소스를 안전하게 정리"
    echo "================================"
